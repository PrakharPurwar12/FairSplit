...
export const Button = ({ children, variant = 'primary', to, href, className = "" }) => {
  ...
  const variants = {
    primary: "bg-[#2563EB] text-primary hover:bg-blue-700 shadow-[0_8px_20px_-6px_rgba(37,99,235,0.5)]",
    secondary: "bg-primary-brand text-white text-[#111827] border border-gray-200 hover:border-gray-300 hover:bg-gray-50",
  };
